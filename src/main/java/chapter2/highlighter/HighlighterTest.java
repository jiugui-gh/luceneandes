...
public class HighlighterTest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Analyzer analyzer = new chapter2.ik.IKAnalyzer6x();
...
*/
        ...
        for (ScoreDoc sd : tds.scoreDocs) {
            ...
            TokenStream tokenStream = TokenSources.getTokenStream(field, null, doc.get("title"), analyzer, 0);
